...
import { Form, Input, Modal, Button, Radio, message, Checkbox, Icon, Row, Col, DatePicker } from 'antd';
  ...
  okHandler = () => {
    ...
    this.props.form.validateFields((err, params) => {
      if (!err) {
        const p = {
          ...params,
          ctime: params['ctime'].format('YYYY-MM-DD HH:mm:ss')
        }
        Modal.confirm({
          title: `确定${title}吗？`,
          content: 'Bla bla ...',
          ...
          onOk: () => {
            const _self = this;
            dispatch({ type: `${namespace}/${option}`, payload: { ...p, id: record.id_ } }).then((data) => {
              console.log(data)
              dispatch({
          ...
          <Form layout='horizontal' onSubmit={this.okHandler}>
            ...
            >
              {getFieldDecorator('ctime', {
                ...
                initialValue: record['ctime'] != null && moment(record['ctime'], 'YYYY-MM-DD HH:mm:ss')
              })(
